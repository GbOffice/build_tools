...
parser.add_option("--db-name", action="store", type="string", dest="db-name", default="gboffice", help="defines the sql db-name wich will be used")
parser.add_option("--db-user", action="store", type="string", dest="db-user", default="gboffice", help="defines the sql db-user wich will be used")
parser.add_option("--db-pass", action="store", type="string", dest="db-pass", default="gboffice", help="defines the sql db-pass wich will be used")
